...
def main():
    print("Running testID3AndEvaluate...")
    testID3AndEvaluate()
    
    print("\nRunning testPruning...")
    testPruning()
    
    print("\nRunning testID3AndTest...")
    testID3AndTest()
    
    # For the testPruningOnHouseData method, you'll need to provide the file path
    # Replace 'your_file_path_here' with the actual path to your house data file
    print("\nRunning testPruningOnHouseData...")
